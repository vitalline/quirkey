...
layout = {
    'words1': [
        ...
        [],
        ['words2', 'pos', 'neg', 'sys', 'other', 'pronouns', 'tags', 'lat', 'cyr', 'ru_words/words1', '', 'enter', 'backspace'],
    ],
    'words2': [
        ...
        ['words1', 'pos', 'neg', 'sys', 'other', 'pronouns', 'tags', 'lat', 'cyr', 'ru_words/words2', '', 'enter', 'backspace'],
    ],
    'pos': [
        ...
        ['words1', 'words2', 'neg', 'sys', 'other', 'pronouns', 'tags', 'lat', 'cyr', 'ru_words/pos', '', 'enter', 'backspace'],
    ],
    'neg': [
        ...
        ['words1', 'words2', 'pos', 'sys', 'other', 'pronouns', 'tags', 'lat', 'cyr', 'ru_words/neg', '', 'enter', 'backspace'],
    ],
    'sys': [
        ...
        ['words1', 'words2', 'pos', 'neg', 'other', 'pronouns', 'tags', 'lat', 'cyr', 'ru_words/sys', '', 'enter', 'backspace'],
    ],
    'other': [
        ...
        ['words1', 'words2', 'pos', 'neg', 'sys', 'pronouns', 'tags', 'lat', 'cyr', 'ru_words/other', '', 'enter', 'backspace'],
    ],
    'pronouns': [
        ...
        ['words1', 'words2', 'pos', 'neg', 'sys', 'other', 'tags', 'lat', 'cyr', 'ru_words/pronouns', '', 'enter', 'backspace'],
    ],
    'tags': [
        ...
        [],
        [],
        ['words1', 'words2', 'pos', 'neg', 'sys', 'other', 'pronouns', 'lat', 'cyr', 'ru_words/tags', '', 'enter', 'backspace'],
    ],
}
